  ...
  nodes: basicSchema.spec.nodes
    .update("paragraph", {
      ...
      toDOM(node) {
        ...
        return [
          "p",
          { style: `text-align: ${align}; font-size: ${size}px;` },
          0,
        ];
      },
      parseDOM: [
...
const App: Component = () => {
  ...
  onMount(() => {
    ...
    const createColorPickerModal = () => {
      ...
      modal.className =
        "color-picker-modal position-absolute bg-white border p-2";
      ...
      colors.forEach((color) => {
        ...
        colorBox.onclick = () => {
          toggleMarkWithAttrs(extendedSchema.marks.color, { color })(
            view.state,
            view.dispatch,
          );
    ...
    createDropdown([
      {
        label: "Normal",
        command: setBlockAttrs({ size: "13", align: "left" }),
      },
      {
        label: "Header 1",
        command: setBlockAttrs({ size: "24", align: "left" }),
      },
      {
        label: "Header 2",
        command: setBlockAttrs({ size: "18", align: "left" }),
      },
    ]);
  ...
  return (
    <div>
      {/* Toolbar */}
      <div class="d-flex align-items-center p-2 bg-light border-bottom flex-wrap">
