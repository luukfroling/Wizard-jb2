...
import { toggleBold, toggleItalic, toggleStrikethrough, toggleSubscript, toggleSuperscript, toggleUnderline } from "./toolbar_commands";
...
function createButtonFromValues(iconString: string, labelString: string, onClickFunction: () => boolean | void, activeBoolean: () => boolean | undefined) {
...
export function createButton(buttonValues: ButtonValues) {
    return createButtonFromValues(buttonValues.icon, buttonValues.label, buttonValues.onClick, buttonValues.active);
}
